...
try:
    ...
    print('One or more required libraries are missing. Installing now...')
    # !pip install numpy
    ...
    # pip install - r os.path('requirements.txt')
...
# Read an image
img = cv2.imread('./static/images/back_image-removebg.png')
